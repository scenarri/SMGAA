## SMGAA
Code for the paper "[Scattering Model Guided Adversarial Examples for SAR Target Recognition: Attack and Defense](https://ieeexplore.ieee.org/abstract/document/9915465)"
